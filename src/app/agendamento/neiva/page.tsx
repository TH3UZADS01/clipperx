...
export default function AgendamentoNeiva() {
  const [service, setService] = useState("");
  const [time, setTime] = useState("");

  const services = [
    { name: "Corte Masculino", price: "R$ 28" },
    { name: "Barba Completa", price: "R$ 22" },
    { name: "Corte + Barba", price: "R$ 45" },
    { name: "Sobrancelha", price: "R$ 12" },
  ];
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    alert(`Agendamento concluído na Barbearia Neiva às ${time} para ${service}`);
  }
  ...
  backdrop-blur-md hover:bg-white/20 transition text-gray-100"
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-300 text-sm">
            Cortes modernos, acabamento detalhado e alto padrão.
          </p>
        </div>
