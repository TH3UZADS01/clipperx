...
export default function AgendamentoABanca() {
  const [service, setService] = useState("");
  const [time, setTime] = useState("");

  const services = [
    { name: "Corte Fade Premium", price: "R$ 30" },
    { name: "Barba Delux", price: "R$ 25" },
    { name: "Corte + Barba", price: "R$ 50" },
    { name: "Sobrancelha Navalhada", price: "R$ 15" },
  ];
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    alert(`Agendamento concluído na Barbearia A Banca às ${time} para ${service}`);
  }
  ...
  backdrop-blur-md hover:bg-white/20 transition text-gray-100"
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-300 text-sm">
            Estilo urbano, fade impecável e atendimento top.
          </p>
        </div>
