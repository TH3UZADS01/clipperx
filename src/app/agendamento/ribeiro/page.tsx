...
export default function AgendamentoRibeiro() {
  const [service, setService] = useState("");
  const [time, setTime] = useState("");

  const services = [
    { name: "Corte Masculino", price: "R$ 25" },
    { name: "Barba Completa", price: "R$ 20" },
    { name: "Corte + Barba", price: "R$ 40" },
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    alert(`Agendamento concluído na Barbearia Ribeiro às ${time} para ${service}`);
  }
  ...
  backdrop-blur-md hover:bg-white/20 transition text-gray-100"
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-300 text-sm">
            Excelência em degradê, barba premium e cortes modernos.
          </p>
        </div>
